...
void atualizaMovimento(float dt)
{
   switch (tolower(direction))
    {
    case 'w':
       Z = Z + gridSize > zMax ? zMax : Z + gridSize;
       movendo = Z != zMax;
    break;
    case 's':
    	Z = Z - gridSize < zMin ? zMin : Z - gridSize;
    	movendo = Z != zMin;
    break;
    case 'a':
        X = X + gridSize > xMax ? xMax : X + gridSize;
       movendo = X != xMax;
    break;
    case 'd':
        X = X - gridSize < xMin ? xMin : X - gridSize;
       movendo = X != xMin;
    break;
    }
