...
bool wrappingMode = 1, magMode = 1, minMode = 1;
int colorMode = 0;
float tiles = 1.0;

//inversão das coordenadas u e v
void display(void)
{
...
void init(void)
{
    ...
    textureManager = new glcTexture();            // Arquivo que cuidará das texturas
    textureManager->SetNumberOfTextures(1);       // Número de texturas que serão usadas
